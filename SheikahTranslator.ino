...
void loop()
{
	...
	//OLED.print6x8Str(0, 1, "KkLlMmNnOoPpQqRrSsTt");
	//OLED.print6x8Str(0, 2, "UuVvWwXxYyZz");

	//OLED.print6x8Str(0, 0, "This has all the shap"); //es. It's also an in-joke, because in German, a glove is a Handschuh (hand shoe), so handglove is an Anglo-German tautology.
	//OLED.print6x8Str(0, 5, "This has all the shap");
	//OLED.print8x8Str(0, 6, "HAPPY BIRTHDAY.");

	//OLED.print8x8Str(6, 0, "A_B_C_D_E_F_G");
	//OLED.print8x8Str(6, 2, "H_I_J_K_L_M_N");
	//OLED.print8x8Str(6, 4, "O_P_Q_R_S_T_U");
	//OLED.print8x8Str(24, 6, "V_W_X_Y_Z_ _.");
